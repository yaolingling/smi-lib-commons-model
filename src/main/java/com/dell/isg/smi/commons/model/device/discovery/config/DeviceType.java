...
@JsonPropertyOrder({ "name", "identifyBy", "identifier", "deviceDefaultCredential", "enabled" })
public class DeviceType {
	 ...
	 *            the enabled
	 */
	public DeviceType(String name, String identifyBy, List<Identifier> identifier,
			DeviceDefaultCredential deviceDefaultCredential, Boolean enabled) {
		super();
		this.name = name;
	 ...
	 *
	 * @param deviceDefaultCredential
	 *            the new device default credential
	 */
	@JsonProperty("deviceDefaultCredential")
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(name).append(identifyBy).append(identifier).append(deviceDefaultCredential)
				.append(enabled).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(name, rhs.name).append(identifyBy, rhs.identifyBy)
				.append(identifier, rhs.identifier).append(deviceDefaultCredential, rhs.deviceDefaultCredential)
				.append(enabled, rhs.enabled).isEquals();
	}
