...
public class IdracCardString {
    ...
    public IdracCardString() {
        super();
    }

    protected String attributeDisplayName = null;
    protected String attributeName = null;
    protected String currentValue = null;
    protected String defaultValue = null;
    protected String dependency = null;
    protected String displayOrder = null;
    protected String fqdd = null;
    protected String groupDisplayName = null;
    protected String groupId = null;
    protected String instanceId = null;
    protected String isReadOnly = null;
